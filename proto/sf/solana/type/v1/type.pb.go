...
// https://github.com/streamingfast/firehose-solana/blob/ad5559c9352a274d2251268e5549d5bcf4239e9d/proto/sf/solana/type/v1/type.proto
...
func file_sf_solana_type_v1_type_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sf_solana_type_v1_type_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sf_solana_type_v1_type_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
